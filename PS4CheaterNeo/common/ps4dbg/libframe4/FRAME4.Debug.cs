...
namespace PS4CheaterNeo.libframe4
{
    ...
    public partial class FRAME4
    {
        ...
        public static string GetLocalIPAddress()
        {
            ...
            foreach (NetworkInterface ni in NetworkInterface.GetAllNetworkInterfaces())
            {
                if ((ni.NetworkInterfaceType == NetworkInterfaceType.Ethernet || ni.NetworkInterfaceType == NetworkInterfaceType.Wireless80211) && ni.OperationalStatus == OperationalStatus.Up
                    && !ni.Description.ToLower().Contains("vmware") && !ni.Description.ToLower().Contains("vethernet") && !ni.Description.ToLower().Contains("radmin"))
                {
        ...
        public void AttachDebugger(int pid, DebuggerInterruptCallback callback)
        {
            ...
            {
                throw new Exception("libframe4: debugger already running?");
            }
        ...
        public void ChangeBreakpoint(int index, bool enabled, ulong address)
        {
            ...
            {
                throw new Exception("libframe4: breakpoint index out of range");
            }
        ...
        public void ChangeWatchpoint(int index, bool enabled, WATCHPT_LENGTH length, WATCHPT_BREAKTYPE breaktype, ulong address)
        {
            ...
            {
                throw new Exception("libframe4: watchpoint index out of range");
            }
