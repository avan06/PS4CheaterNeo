...
namespace PS4CheaterNeo.libdebug
{
    ...
    /// </summary>
    public partial class PS4DBG : IPS4DBG
    {
        ...
        public string ExtPS4DBGVersion { get; private set; } = "";

        private Thread debugThread = null;

        // some global values
        private const string LIBRARY_VERSION = "1.2.5";
        ...
        public enum CMDS : uint
        {
            ...
            CMD_EXT_DBG_VERSION = 0xBD000501,
            ...
            CMD_PROC_SCAN_NEXT  = 0xBDAACC02,
            CMD_PROC_SCAN_END   = 0xBDAACC06,
            CMD_PROC_SCAN_FF    = 0xBDAACCFF,
        ...
        public int GetExtFWVersion()
        {
            ...
            try
            {
                ...
                if (result.AsyncWaitHandle.WaitOne(1000, true))
                {
                    ...
                    Console.WriteLine("Ext FW Version: " + ExtFWVersion);
                    GetExtDBGVersion();
                    Console.WriteLine("Ext PS4DBG Version: " + ExtPS4DBGVersion);
                }
                else
                {
        ...
        /// <summary>
        /// ps4debug ext DBG by ctn123
        /// </summary>
        public string GetExtDBGVersion()
        {
            if (ExtPS4DBGVersion != "") return ExtPS4DBGVersion;

            CheckConnected();

            SendCMDPacket(CMDS.CMD_EXT_DBG_VERSION, 0);
